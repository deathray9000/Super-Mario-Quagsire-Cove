...
#define SOUND_ACTION_WOOPER_ATTACKED             /* 0x00604080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x70, 0xC0, SOUND_DISCRETE)
#define SOUND_ACTION_WOOPER_TALKING              /* 0x00604080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x71, 0xC0, SOUND_DISCRETE)
#define SOUND_ACTION_NOTEBLOCK                   /* 0x00604080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x72, 0xC0, SOUND_DISCRETE)
#define SOUND_ACTION_CHECKPOINT                  /* 0x00604080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x73, 0xC0, SOUND_DISCRETE)
#define SOUND_ACTION_PIPE_RISE                     /* 0x00604080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,     0x74, 0xC0, SOUND_DISCRETE)
#define SOUND_ACTION_PIPE_LOWER                    /* 0x00604080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,     0x75, 0xD0, SOUND_DISCRETE)
#define SOUND_ACTION_QUAG_ATTACKED             /* 0x00604080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x76, 0xC0, SOUND_DISCRETE)
#define SOUND_ACTION_QUAG_TALKING              /* 0x00604080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x77, 0xC0, SOUND_DISCRETE)
...
#define SOUND_PROPELLER                          /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x40, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_GENERAL_BREAK_BOX                  /* 0x3041C080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x41, 0x80, SOUND_DISCRETE) // unverified
...
//0xA
#define SOUND_CUSTOM_SMW_JUMP                    /* 0xA0008081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_1, 0x00, 0x60, SOUND_DISCRETE)
#define SOUND_CUSTOM_SMW_SPIN                    /* 0xA0018081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_1, 0x01, 0x60, SOUND_DISCRETE)
#define SOUND_CUSTOM_SMW_KICK                    /* 0xA0028081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_1, 0x02, 0x60, SOUND_DISCRETE)
#define SOUND_CUSTOM_SMW_STOMP                   /* 0xA0038081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_1, 0x03, 0x70, SOUND_DISCRETE)
#define SOUND_CUSTOM_SMW_HURT                    /* 0xA0048081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_1, 0x04, 0x80, SOUND_DISCRETE)
#define SOUND_CUSTOM_SMW_DEATH                   /* 0xA0058081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_1, 0x05, 0xFF, SOUND_LOWER_BACKGROUND_MUSIC | SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_CUSTOM_SMW_SUPER_STOMP             /* 0xA0068081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_1, 0x06, 0x70, SOUND_DISCRETE)
#define SOUND_CUSTOM_SMW_MESSAGE                 /* 0xA0078081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_1, 0x07, 0x80, SOUND_DISCRETE)
#define SOUND_CUSTOM_STUFFWELL                   /* 0xA0088081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_1, 0x08, 0x60, SOUND_DISCRETE)
//0xB
#define SOUND_CUSTOM_SMW_SLAM                    /* 0xB0008081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_2, 0x00, 0x60, SOUND_DISCRETE)
#define SOUND_CUSTOM_SMW_COIN                    /* 0xB0018081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_2, 0x01, 0x70, SOUND_DISCRETE)
#define SOUND_CUSTOM_SMW_SHATTER                 /* 0xB0028081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_2, 0x02, 0x80, SOUND_DISCRETE)
#define SOUND_CUSTOM_SMW_SWITCH                  /* 0xB0038081 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_FOREGROUND_2, 0x03, 0x80, SOUND_DISCRETE)
