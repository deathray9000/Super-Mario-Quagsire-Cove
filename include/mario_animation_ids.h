...
enum MarioAnimID {
    ...
    /* 0x38 */ MARIO_ANIM_WATER_SPIN_END,
    ...
    /* 0xD1 */ MARIO_ANIM_LADDER_L,
    /* 0xD2 */ MARIO_ANIM_LADDER_DL,
    /* 0xD3 */ MARIO_ANIM_LADDER_R,
    /* 0xD4 */ MARIO_ANIM_LADDER_DR
};
