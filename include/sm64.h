...
#define ACT_EXIT_PIPE                  0x0000190C // (0x10B | ACT_FLAG_AIR | ACT_FLAG_INTANGIBLE)
...
#define ACT_CLIMBING_LADDER            0x08100346 // (0x146 | ACT_FLAG_STATIONARY | ACT_FLAG_ON_POLE | ACT_FLAG_PAUSE_EXIT)
