...
const BehaviorScript *sWarpBhvSpawnTable[] = {
    ...
    bhvAirborneStarCollectWarp, bhvAirborneDeathWarp,      bhvLaunchStarCollectWarp,   bhvLaunchDeathWarp, bhvOGpipe, 
    bhvCheckpoint_Flag,
};
...
u8 sSpawnTypeFromWarpBhv[] = {
    ...
    MARIO_SPAWN_AIRBORNE_STAR_COLLECT, MARIO_SPAWN_AIRBORNE_DEATH,       MARIO_SPAWN_LAUNCH_STAR_COLLECT,   MARIO_SPAWN_LAUNCH_DEATH, MARIO_SPAWN_PIPE2, 
    MARIO_SPAWN_DEATH, 
};
