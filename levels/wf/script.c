...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, 4960, 5499, -4345, 0, 90, 0, (0x0F << 16), bhvExclamationBox),
		OBJECT(MODEL_CHECKPOINT_FLAG, 4537, 5075, -4792, 0, 0, 0, (0x01 << 16) | (0x02 << 8), bhvCheckpoint_Flag),
		OBJECT(MODEL_OG_PIPE, 5443, 5075, -4792, 0, 0, 0, (0xA << 16), bhvOGpipe),
		OBJECT(MODEL_OG_PIPE, 5858, -6729, -916, 0, 0, 0, (0xB << 16), bhvOGpipe),
		OBJECT(MODEL_OG_PIPE, 5558, -6729, -916, 0, 0, 0, (1 << 24) | (0xC << 16), bhvOGpipe),
		OBJECT(MODEL_NOTE_BLOCK, -3256, 231, 7111, 0, 0, 0, (1 << 16), bhvNoteBlock),
		OBJECT(MODEL_QUAGSIRE, 4960, 5075, -4792, 0, 90, 0, (0x08 << 16), bhvQuagsire),
		OBJECT(MODEL_OG_PIPE, 5443, 5075, -4192, 0, 0, 0, (1 << 24) | (0xD << 16) | (1 << 8), bhvOGpipe),
		OBJECT(MODEL_STAR, 5862, -6346, -2559, 0, 0, 0, (18 << 24), bhvStar),
		OBJECT(MODEL_STAR_STATUE, 4547, -6729, -3369, 0, 0, 0, (17 << 24), bhvStarStatue),
		OBJECT(MODEL_WOOPER, 4960, 5075, -4474, 0, 90, 0, (0x08 << 16), bhvWooper),
