COURSE_ACTS(COURSE_BOB, _(" 1 TOAD HARBOR"),
...
COURSE_ACTS(COURSE_WF, _(" 2 PIRANHA BAY"),
       _("-")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
       _("RED COINS ON THE FLOATING ISLE"), _("FALL ONTO THE CAGED ISLAND")    , _("BLAST AWAY THE WALL"))

COURSE_ACTS(COURSE_JRB, _(" 3 OCEANVIEW VILLAGE"),
...
COURSE_ACTS(COURSE_CCM, _(" 4 SKY SANCTUARY"),
       _("-")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
       _("FROSTY SLIDE FOR 8 RED COINS")  , _("SNOWMAN'S LOST HIS HEAD")       , _("WALL KICKS WILL WORK"))

COURSE_ACTS(COURSE_BBH, _(" 5 WHOMP'S BLOCKADE"),
...
COURSE_ACTS(COURSE_HMC, _(" 6 NUOH FOREST"),
...
COURSE_ACTS(COURSE_LLL, _(" 7 HIGHLAND SPRINGS"),
...
COURSE_ACTS(COURSE_SSL, _(" 8 TERRAFROST MOUNTAIN"),
       _("-") , _("SHINING ATOP THE PYRAMID")      , _("INSIDE THE ANCIENT PYRAMID"),
       _("STAND TALL ON THE FOUR PILLARS"), _("FREE FLYING FOR 8 RED COINS")   , _("PYRAMID PUZZLE"))

COURSE_ACTS(COURSE_DDD, _(" 9 PETRIFIED DESERT"),
...
COURSE_ACTS(COURSE_SL, _("10 ABANDONED MANOR"),
...
COURSE_ACTS(COURSE_WDW, _("11 SUNSET SHORES"),
...
COURSE_ACTS(COURSE_TTM, _("12 DRIP DROP CAVE"),
...
COURSE_ACTS(COURSE_THI, _("13 BOWSER'S SEASIDE FORTRESS"),
...
COURSE_ACTS(COURSE_TTC, _("14 LUMIOSE OUTSKIRTS"),
...
COURSE_ACTS(COURSE_RR, _("15 MOLTEN CORE"),
